...
function Footer(){
    return(
        <section className="footersection">
            <motion.div initial={{opacity:0.2, scale:0.2}} transition={{duration:3}} whileInView={{opacity:1, scale:1}} className="socialcontainer">
            ...
            <motion.div initial={{opacity:0.2, scale:0.2}} transition={{duration:3}} whileInView={{opacity:1, scale:1}} className="linksforres">
                <a href="#home">Home</a>
            ...
            <div className="reach">
                <motion.p initial={{opacity:0.2, scale:0.2}} transition={{duration:3}} whileInView={{opacity:1, scale:1}}>Designed & Developed By Suryansh Ruhal</motion.p>
                <motion.p initial={{opacity:0.2, scale:0.2}} transition={{duration:3}} whileInView={{opacity:1, scale:1}}>Copyright @ 2024 Ruhal || All Rights Reserved</motion.p>
            </div>
        </section>
    );
}
