...
function Home(){
    return(
        <section id="home" className="homecontainer">
            <motion.div initial={{opacity:0.2, scale:0.2}} transition={{duration:2}} whileInView={{opacity:1, scale:1}} className="textcontainer">
                <h3 > Hii there, this is</h3>
                <motion.h2 variants={entry(1.6)} initial="initial" whileInView="animate" className="name" >SURYANSH RUHAL</motion.h2>
                <h2 >I am a</h2><h1><Typewriter 
           options={{ 
           ...
           /></h1>
                <motion.h2 variants={entry(2)} initial="initial" whileInView="animate">here is my Portfolio: a little Sneak Peak to my journey of becoming a developer </motion.h2>
                <motion.div variants={entry(2.2)} initial="initial" whileInView="animate" drag >
                ...
                <motion.div variants={entry(2.6)} initial="initial" whileInView="animate" className="socialcontainer h">
            ...
            <motion.div  initial={{x:100,opacity:0}}  whileInView={{x:0,opacity:1}} transition={{duration: 1 ,delay:1.8}}className="myimgcontainer" >
